...
public class IndexableList<E> {
    ...
    public void aumentarEsquerdaArray(int extensao) {
        ...
        for (int i = 0; i < extensao; i++) { //numElem1
    ...
    public void aumentar(int extensao) {
        ...
        for (int i = 0; i < extensao; i++) { //numElemDireita
    ...
    public E remover(int index) {
        E removedItem = get(index);//E removedItem = get(index);
    ...
    public E set(int index, E elemento) {
        ...
        if (index < numElem1) {
            ...
            arrayDireita[index - numElem1] = elemento;
        }
        return e;
    }
